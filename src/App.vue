<template>
  <f7-app v-bind="f7params">
    ...
    <f7-views tabs class="safe-areas">
      ...
      <f7-view id="view-home" browser-history main tab tab-active url="/"></f7-view>

      <!-- About View -->
      <f7-view id="view-about" browser-history name="about" tab url="/about/"></f7-view>
    ...
    <f7-popup id="my-popup">
      <f7-view>
        <f7-page>
          ...
          <f7-block>
            <p>Popup content goes here222.</p>
          </f7-block>
        </f7-page>
      </f7-view>
    </f7-popup>
